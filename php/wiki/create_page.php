...
if (mysqli_num_rows($result) == 0){
    header("Location: " . $_REDIRECT . "?error=" . Errors::$_ERROR_CATEGORY_NOT_EXIST);
    exit;
}

$result = mysqli_fetch_assoc($result);
$category_id = $result["id"];
mysqli_query($db, "INSERT INTO pages (content, name, category_id, category) values('', '$name', '$category_id', '0')");
